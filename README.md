...
7. [Оптимизации](#Оптимизации)
	- [Получение, фильтрация и нормализация данных из загруженных пользователем файлов](#Получение,-фильтрация-и-нормализация-данных-из-загруженных-пользователем-файлов)
...
#### `Получение, фильтрация и нормализация данных из загруженных пользователем файлов`
