import { ChartDataType, Pack, PackProfile } from './types';
...
export const packProfile: PackProfile = {
  audio:
		'https://sample-cloud.storage.yandexcloud.net/PACK-AUDIO/b6906d94-10b8-4794-a6e2-472a9f5a5862.wav',
  genre: 'Bass House',
  listens: 0,
  name: 'James Blake',
  ...
  samples: [
    {
      ...
      audio:
				'https://sample-cloud.storage.yandexcloud.net/SAMPLES-AUDIO/39f8091d-557f-4c59-a2af-e6c554ba4036.wav',
