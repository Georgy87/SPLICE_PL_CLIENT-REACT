    ...
    return (
        <div className={styles.player}>
            ...
            <div className={styles.initialInformation}>
                ...
                <p>
                    Samples are a source of inspiration. It’s what you do with them that matters. SampleCloud allows you
                    to shape millions of royalty-free samples to your sound.
                </p>
            </div>
        </div>
    );
