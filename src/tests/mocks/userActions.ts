...
export const user: UserSliceState = {
  ...
  token:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxOGViYjVhNjI5M2MzMGY0MTU2ODAyYSIsImlhdCI6MTY3MzM3NTAyNSwiZXhwIjoxNjc1OTY3MDI1fQ.Q4QVOA4BnxBzUSWWrabb5oduK9kB4VqAK3ix6ShpF6o',
  isAuth: false,
  samples: null,
  avatar: null,
  loading: false,
